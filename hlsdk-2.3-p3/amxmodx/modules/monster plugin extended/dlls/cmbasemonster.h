...
class CMBarnacle : public CMBaseMonster
{
public:
	void Spawn( void );
	void Precache( void );
	edict_t *TongueTouchEnt ( float *pflLength );
	int  Classify ( void );
	void HandleAnimEvent( MonsterEvent_t *pEvent );
...
class CMBloater : public CMBaseMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
class CMTentacle : public CMBaseMonster
{
public:
	CMTentacle( void );
	...
	void EXPORT CommandUse( edict_t *pActivator, edict_t *pCaller, USE_TYPE useType, float value );
	void EXPORT Start( void );
	void EXPORT DieThink( void );

	void EXPORT Test( void );

	void EXPORT HitTouch( edict_t *pOther );
...
class CMGMan : public CMBaseMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
class CMLeech : public CMBaseMonster
{
public:
	void Spawn( void );
	void Precache( void );
	...
	void Touch( edict_t *pOther )
	{
		if ( UTIL_IsPlayer(pOther) )
		{
			...
			{
				pev->basevelocity = pOther->v.velocity;
	...
	float ObstacleDistance( edict_t *pTarget );
	...
	int IRelationship( edict_t *pTarget );
...
class CMSpiral : public CMBaseEntity
{
public:
	void Spawn( void );
	void Think( void );
	int ObjectCaps( void ) { return FCAP_DONT_SAVE; }
	static CMSpiral *Create( const Vector &origin, float height, float radius, float duration );
};
...
class CMSmoker : public CMBaseEntity
{
public:
	void Spawn( void );
	void Think( void );
...
class CMIchthyosaur : public CMFlyingMonster
{
public:
	void  Spawn( void );
	void  Precache( void );
	...
	void EXPORT CombatUse( edict_t *pActivator, edict_t *pCaller, USE_TYPE useType, float value );
	void EXPORT BiteTouch( edict_t *pOther );
