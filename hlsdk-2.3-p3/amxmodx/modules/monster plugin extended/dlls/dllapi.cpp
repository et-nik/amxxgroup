...
bool spawn_monster(int monster_type, Vector origin, float angle, int respawn_index)
{
   ...
   switch (monster_type)
   {
      ...
      case 1: monsters[monster_index].pMonster = CreateClassPtr((CMApache *)NULL);
              break;
	  case 2: monsters[monster_index].pMonster = CreateClassPtr((CMBarnacle *)NULL);
              break;
      case 3: monsters[monster_index].pMonster = CreateClassPtr((CMBarney *)NULL);
              break;
      case 4: monsters[monster_index].pMonster = CreateClassPtr((CMBigMomma *)NULL);
              break;
	  case 5: monsters[monster_index].pMonster = CreateClassPtr((CMBloater *)NULL);
              break;
      case 6: monsters[monster_index].pMonster = CreateClassPtr((CMBullsquid *)NULL);
              break;
      case 7: monsters[monster_index].pMonster = CreateClassPtr((CMController *)NULL);
              break;
	  case 8: monsters[monster_index].pMonster = CreateClassPtr((CMGargantua *)NULL);
              break;
	  case 9: monsters[monster_index].pMonster = CreateClassPtr((CMGMan *)NULL);
              break;
      case 10: monsters[monster_index].pMonster = CreateClassPtr((CMHAssassin *)NULL);
              break;
      case 11: monsters[monster_index].pMonster = CreateClassPtr((CMHeadCrab *)NULL);
              break;
      case 12: monsters[monster_index].pMonster = CreateClassPtr((CMHGrunt *)NULL);
              break;
      case 13: monsters[monster_index].pMonster = CreateClassPtr((CMHoundeye *)NULL);
              break;
	  case 14: monsters[monster_index].pMonster = CreateClassPtr((CMIchthyosaur *)NULL);
              break;
      case 15: monsters[monster_index].pMonster = CreateClassPtr((CMISlave *)NULL);
              break;
	  case 16: monsters[monster_index].pMonster = CreateClassPtr((CMLeech *)NULL);
              break;
      case 17: monsters[monster_index].pMonster = CreateClassPtr((CMScientist *)NULL);
              break;
      case 18: monsters[monster_index].pMonster = CreateClassPtr((CMSqueakGrenade *)NULL);
              break;
	  case 19: monsters[monster_index].pMonster = CreateClassPtr((CMTentacle *)NULL);
              break;
      case 20: monsters[monster_index].pMonster = CreateClassPtr((CMZombie *)NULL);
              break;
