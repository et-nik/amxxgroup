...
CMSoundEnt *pSoundEnt;

//=========================================================
// CSound - Clear - zeros all fields for a sound
//=========================================================
void CMSound :: Clear ( void )
{
...
//=========================================================
void CMSoundEnt :: Think ( void )
{
	int iSound;
	int iPreviousSound;

	v.nextthink = gpGlobals->time + 0.3;// how often to check the sound list.
...
//=========================================================
void CMSoundEnt :: FreeSound ( int iSound, int iPrevious )
{
	if ( !pSoundEnt )
	{
		// no sound ent!
...
//=========================================================
int CMSoundEnt :: IAllocSound( void )
{
	int iNewSound;
...
// sound info.
//=========================================================
void CMSoundEnt :: InsertSound ( int iType, const Vector &vecOrigin, int iVolume, float flDuration )
{
	int	iThisSound;
...
// free sound list.
//=========================================================
void CMSoundEnt :: Initialize ( void )
{
  	int i;
	int iSound;
...
// sound list.
//=========================================================
int CMSoundEnt :: ISoundsInList ( int iListType )
{
	int i;
	int iThisSound;
...
//=========================================================
int CMSoundEnt :: ActiveList ( void )
{
	if ( !pSoundEnt )
	{
		return SOUNDLIST_EMPTY;
...
//=========================================================
CMSound*	CMSoundEnt :: SoundPointerForIndex( int iIndex )
{
	if ( !pSoundEnt )
	{
		return NULL;
...
//=========================================================
int CMSoundEnt :: ClientSoundIndex ( edict_t *pClient )
{
