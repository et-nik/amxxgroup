...
skill_cfg_t skill_cfg[] = {
   ...
   {"sk_barnacle_health", &gSkillData.BarnacleHealth},
   {"sk_tentacle_health", &gSkillData.TentacleHealth},
   {"", NULL}
};
...
void monster_skill_init(void)
{
   ...
   FILE *fp = NULL;
	...
	// BARNACLE
	gSkillData.BarnacleHealth = 50.0f;

	// TENTACLE
	gSkillData.TentacleHealth = 200.0f;
