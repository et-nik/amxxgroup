...
//=========================================================
class CMSoundEnt : public edict_t 
{
public:
	...
	static CMSound*	SoundPointerForIndex( int iIndex );// return a pointer for this index in the sound list
...
private:
	CMSound		m_SoundPool[ MAX_WORLD_SOUNDS ];
};
